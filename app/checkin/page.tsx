    ...
    <div className="p-4 pb-24">
      ...
      <div className="card text-center py-8">
        ...
        <h2 className="text-2xl font-bold mb-1">
          {checkinStatus === 'checked_in' ? '已打卡' : '未打卡'}
        </h2>
        <p className="text-gray-500 text-sm">
          {checkinStatus === 'checked_in' ? '当前状态: 上班中' : '请点击下方按钮打卡'}
        </p>
          ...
          <div className="space-y-3">
            {todayCheckins.map((record) => (
              <div key={record.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                ...
                <span className={`text-sm font-medium ${statusColors[record.status as keyof typeof statusColors]}`}>
